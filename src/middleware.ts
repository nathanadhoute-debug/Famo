...
export async function middleware(request: NextRequest) {
  ...
  const publicRoutes = ["/login", "/signup", "/invite", "/auth", "/confirm-email", "/forgot-password", "/reset-password", "/confidentialite"];
...
export const config = {
  matcher: ["/((?!_next/static|_next/image|favicon.ico|icon|apple-icon|api/webhooks|api/cron).*)"],
};
